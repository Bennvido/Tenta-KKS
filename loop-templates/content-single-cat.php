  ...
  <div class="row no-gutters">
    ...
    <div class="col-lg-4">
      <div class="card-body font-italic">
        ...
        <p class="card-text"><strong><?php _e('Adopted:', 'kks') ?></strong> <?php the_field('cat_adopted') ?> <?php if (get_field('cat_date_adopted')) : ?> <?php __('at', 'kks') ?> <?php endif; ?> <?php the_field('cat_date_adopted') ?> </p>
        <p class="card-text"><strong><?php _e('Description:', 'kks') ?></strong> <?php the_field('cat_description') ?></p>
        <p class="card-text"><small class="text-muted"> <?php printf(
                                                          __('Updated at: %1$s at  %2$s', 'kks'),
